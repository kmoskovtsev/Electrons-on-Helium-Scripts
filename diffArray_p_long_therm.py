...
N_therm = 3e6 # n_steps to reach energy balance, roughly reciprocal phonon scattering rate
...
#++++++-------+++++++++===============
#Take thermalization rate half as slow as usual
wk_ph *= 10 # Increase the energy relaxation rate artificially. Factor 20 corresponds to roughly 10^6 1/s rate.
k_arr = np.linspace(kmin, kmax, Nk)
